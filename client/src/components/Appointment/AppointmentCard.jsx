...
const AppointmentCard = (props) => {
  let date = new Date(props.info.appointSchedule).toLocaleDateString(
    undefined,
    {
      year: "numeric",
      month: "long",
  ...
  return (
    <div className="h-fit flex flex-row bg-[white] shadow rounded m-1 relative">
      ...
      <div className="rounded  flex-auto m-1 w-[10%] flex justify-center items-center">
        {props.info.appointment_type}
      </div>
      <div className="rounded  flex-auto m-1 w-[10%] flex justify-center items-center">
        {props.info.appointment_status}
      </div>
      <div className="rounded flex-auto m-1 w-[10%] flex justify-center items-center">
        {props.info.cost}
      </div>
      ...
      <div className="rounded flex-auto m-1 w-[5%] flex justify-center items-center">
        <svg
          ...
          onClick={() => props.deleteHandler(props.info.appointment_id)}
        >
          <path
            fillRule="evenodd"
